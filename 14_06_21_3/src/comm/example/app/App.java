...
public class App {
	...
	public static void main(String args[])
	{
		...
		int choice=0;
		Set<comm.example.Employee> set=new TreeSet<comm.example.Employee>();
		App app=new App();
		...
		set.add(new comm.example.Employee(UUID.randomUUID().toString(),fname,lname,email,salary));

		 break;

		case 2:

			Iterator<comm.example.Employee> i=set.iterator();
			while(i.hasNext())
			{
//				Employee emp=i.next();
